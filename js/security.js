/**
 * ======================================================
 * NS-COMPANY-REVIEW™ FULL SECURITY SHIELD v2.0
...
(function () {
    ...
    // 1. DOMAIN ANTI-CLONING LOCK
    // ==========================================
    // ONLY these domains are authorized to run NS-COMPANY-REVIEW.
    // file:/// (empty hostname) will be blocked immediately.
    var allowedDomains = [
        'nscrv.vercel.app',
        'ns-company-review.vercel.app',
        'www.nscrv.com',
        'nscrv.com',
        'localhost',
        '127.0.0.1'
    ...
    securityCSS.id = 'nsc-security-css';
    securityCSS.textContent = [
        ...
        'img { -webkit-user-drag: none !important; -khtml-user-drag: none !important; -moz-user-drag: none !important; -o-user-drag: none !important; user-drag: none !important; }',
        '.fullscreen-img { pointer-events: auto !important; cursor: zoom-in !important; }',
        '.fullscreen-img.expanded { pointer-events: auto !important; cursor: zoom-out !important; }',
        'a img, button img, [onclick] img { pointer-events: auto !important; }',
    ...
    if (typeof console !== 'undefined') {
        var warningCSS = 'color: cyan; font-size: 24px; font-weight: bold; text-shadow: 0 0 10px cyan;';
        var detailCSS = 'color: #00ffff; font-size: 14px;';
        try {
            ...
            console.log('%cNS-COMPANY-REVIEW™ Security Suite is monitoring this console.', detailCSS);
        } catch (e) { }
    }
    ...
    if (typeof MutationObserver !== 'undefined') {
        var observer = new MutationObserver(function (mutations) {
            mutations.forEach(function (mutation) {
                if (!document.getElementById('nsc-security-css')) {
                    if (document.head) {
